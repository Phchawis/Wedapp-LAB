...
export const DOC_TYPES = [
  ...
  { code: 'SOP', th: 'ระเบียบปฏิบัติ', en: 'Standard Procedure' },
...
export const WORK_CATEGORIES = [
  ...
  { code: 'POCT', th: 'บริหารจัดการเครื่องมือ ณ จุดดูแลผู้ป่วย', en: 'Point-of-Care Testing' },
...
export const DOCS = [
  ...
  { no: 'SOP-IMM-014', th: 'การควบคุมคุณภาพการตรวจภูมิคุ้มกัน', type: 'SOP', cat: 'IMM', rev: 2, status: 'effective', updated: '2026-04-28', owner: 'ทนพ. ธนกร พงษ์', files: ['pdf', 'word'], reads: 38, total: 41, retention: 5 },
  ...
  { no: 'SOP-CHE-009', th: 'การควบคุมคุณภาพการตรวจเคมีคลินิก', type: 'SOP', cat: 'CHE', rev: 5, status: 'effective', updated: '2026-05-08', owner: 'ทนพ. ณัฐพล ว.', files: ['pdf', 'word'], reads: 47, total: 52, retention: 5 },
  ...
  { no: 'EF-POCT-002', th: 'บันทึกผลควบคุมคุณภาพเครื่องตรวจน้ำตาลปลายนิ้ว', type: 'EF', cat: 'POCT', rev: 1, status: 'effective', updated: '2026-06-01', owner: 'ทนพ. อดิเทพ ค.', files: ['url'], reads: 12, total: 30, retention: 2 },
